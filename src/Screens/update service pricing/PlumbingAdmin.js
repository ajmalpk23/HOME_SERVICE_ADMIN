...
const PlumbingAdmin = ({navigation}) => {
  return (
    <View style={{flex: 1, backgroundColor: Colors.backgroundcolor,height:'100%'}}>
        ...
        <Text style={styles.txt2}>Plumbing Work</Text>
      </View>
         ...
         {/* firsr row */}
          <View style={{flexDirection: 'row', justifyContent: 'space-around',top:'10%'}}>
            <TouchableOpacity
              ...
              onPress={() => {
                navigation.navigate('Sanitizationservices', {head: 'Basin & Sink'});
              }}>
              <Image
            ...
            <TouchableOpacity
              style={styles.continer}
              onPress={() => {
                navigation.navigate('Sanitizationservices', {head: 'Tap & Mixer'}); }}
                >
              <Image
          ...
          <View style={{top:'25%'}}>
            <View
              ...
              <TouchableOpacity
                style={styles.continer}
                onPress={() => {
                  navigation.navigate('Sanitizationservices', {head: 'Motor'});
                }}>
                <Image
              ...
              <TouchableOpacity
                style={styles.continer}
                onPress={() => {
                  navigation.navigate('Sanitizationservices', {head: 'Toilet'});
                }}>
                <Image
          ...
          <View style={{top:'40%'}}>
            <View
              ...
              <TouchableOpacity
                style={styles.continer}
                onPress={() => {
                  navigation.navigate('Sanitizationservices', {head: 'Bath Fitting'});
                }}>
                <Image
